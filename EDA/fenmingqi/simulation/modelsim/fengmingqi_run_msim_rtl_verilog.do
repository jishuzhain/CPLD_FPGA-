...
vlog -vlog01compat -work work +incdir+G:/CPLD_FPGA/EDA/fenmingqi {G:/CPLD_FPGA/EDA/fenmingqi/fengmingqi.v}

vlog -vlog01compat -work work +incdir+G:/CPLD_FPGA/EDA/fenmingqi/simulation/modelsim {G:/CPLD_FPGA/EDA/fenmingqi/simulation/modelsim/fengmingqi.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L maxii_ver -L rtl_work -L work -voptargs="+acc" fengmingqi_vlg_tst
