...
vlog -vlog01compat -work work +incdir+G:/CPLD_FPGA/EDA/jicunqi_1 {G:/CPLD_FPGA/EDA/jicunqi_1/jicunqi.v}

vlog -vlog01compat -work work +incdir+G:/CPLD_FPGA/EDA/jicunqi_1/simulation/modelsim {G:/CPLD_FPGA/EDA/jicunqi_1/simulation/modelsim/jicunqi.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L maxii_ver -L rtl_work -L work -voptargs="+acc" jicunqi_vlg_tst
